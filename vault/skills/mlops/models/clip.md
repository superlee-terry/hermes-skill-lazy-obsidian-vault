...
metadata:
  hermes:
    ...
    - Content Moderation
name: clip
summary: OpenAI's model connecting vision and language. Enables zero-shot image classification,
  image-text matching, and cross-modal retrieval. Trained on 400M image-text pairs.
  Use for image search, content m
triggers:
- Multimodal
- CLIP
- Vision-Language
