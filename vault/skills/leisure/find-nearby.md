...
metadata:
  hermes:
    ...
    - local
name: find-nearby
summary: Find nearby places (restaurants, cafes, bars, pharmacies, etc.) using OpenStreetMap.
  Works with coordinates, addresses, cities, zip codes, or Telegram location pins.
  No API keys needed.
triggers:
- location
- maps
